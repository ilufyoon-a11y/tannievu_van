...
async def manejar_botones_pirata(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "unirme_pirata_click":
        ...
        await query.answer("¡𝖴𝗉𝗌, 𝖾𝗌𝖺 𝗋𝖺𝗇𝗎𝗋𝖺 𝗒𝖺 𝗍𝗂𝖾𝗇𝖾 𝗎𝗇𝖺 𝖾𝗌𝗉𝖺𝖽𝖺 𝗂𝗇𝗌𝖾𝗋𝗍𝖺𝖽𝖺, 𝖾𝗅𝗂𝗀𝖾 𝗈𝗍𝗋𝖺!", show_alert=True)        sesion_puntos["premio_actual"]["pirata"] = int(args[0]) if args else 0
    except ValueError:
        pass
